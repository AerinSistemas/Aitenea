...
module.exports = {
    ...
    uiPort: process.env.NODERED_PORT,
    ...
    paletteCategories: ['AItenea Data Cleaning', 'AItenea Connector', 'AItenea Smart Pipe' ,'subflows', 'common', 'function', 'network', 'sequence', 'parser', 'storage'],
    ...
    editorTheme: {
        page: {
            title: "AItenea",
            favicon: "/data/styles/images/favicon.ico",
            css: "/data/styles/css/aitenea.css",
        },
        header: {
            title: " ",
            image: "/data/styles/images/aitenea.png", // or null to remove image
            url: "https://www.aerin.es/aitenea.html" // optional url to make the header text/image a link to this url
        },
        deployButton: {
            type:"simple",
            label:"Deploy",
